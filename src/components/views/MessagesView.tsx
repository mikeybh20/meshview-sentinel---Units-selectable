...
export function MessagesView({
  ...
  // v2.0 Beta 3: per-radio channel resolution is hoisted to App.tsx — the
  // `channels` prop coming in already reflects whichever radio is selected
  // in the top bar (so activeChannel + filteredMessages + this sidebar all
  // line up on the same channel set).
