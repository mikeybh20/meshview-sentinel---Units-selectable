...
//
// v2.1 refactor: domain types now live in ./meshtastic/types.ts so this
// file can focus on the bridge class (still ~6000 LOC of protocol +
// send + ACK + retention logic). All exports below are re-exported
// so every existing import of these names from './meshtasticSerial.js'
// keeps working — no consumer churn for the type-extraction pass.
export type {
  MeshNode, MeshMessage, MeshEvent, MeshGroup, ChannelRole, MeshChannel,
  MeshWaypoint, TraceHop, NeighborObservation, NeighborInfoSnapshot,
  StoreForwardStats, NeighborInfoModuleConfig, RangeTestModuleConfig,
  TelemetryModuleConfig, DetectionSensorModuleConfig, AudioModuleConfig,
  SerialModuleConfig, AmbientLightingModuleConfig, PaxcounterModuleConfig,
  RemoteHardwarePin, RemoteHardwareModuleConfig, MqttModuleConfig,
  ExternalNotificationModuleConfig, StoreForwardLocalConfig,
  NetworkConfigSnapshot, PowerConfigSnapshot, DeviceConfigSnapshot,
  PositionConfigSnapshot, DisplayConfigSnapshot, BluetoothConfigSnapshot,
  LoRaConfigSnapshot, LocalModuleConfigSnapshot, MeshStoreForwardRouter,
  MeshTraceResult, TransportMode, TcpEndpoint,
} from './meshtastic/types.js';
import type {
  MeshNode, MeshMessage, MeshEvent, MeshGroup, ChannelRole, MeshChannel,
  MeshWaypoint, TraceHop, NeighborObservation, NeighborInfoSnapshot,
  StoreForwardStats, NeighborInfoModuleConfig, RangeTestModuleConfig,
